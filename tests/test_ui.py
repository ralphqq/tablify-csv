...
def mocked_process_column(mocker):
    mocked_method = mocker.patch.object(UserColumnSettings, "_process_column")
...
def test_does_not_store_columns_with_no_user_settings(
    user_input, mocked_process_column
):
